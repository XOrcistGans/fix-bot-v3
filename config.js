// S C R I P T  O R I  B Y  𝐗𝐎𝐫𝐜𝐢𝐬𝐭𝐆𝐚𝐧𝐬 And KANNACHAN 🔭
...
let wibh = moment.tz('Asia/Jakarta').format('HH')
    ...
    // Offset    0 is  0.00
    // Offset  420 is  7.00
    let weton = ['Pahing', 'Pon', 'Wage', 'liwon', 'Legi'][Math.floor(d / 84600000) % 5]
...
global.owner = [
  ...
  ['-', 'Halo Beban', true],
  ['-', 'Pasti lu jomblo ya', true],
  ['-', 'Jangan Lupa Sve Wa gw', true],
  ['-', 'Silahkan Beban', true]
